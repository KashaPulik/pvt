...
def draw(filenames, labels):
    ...
    plt.tight_layout()
    ax.legend()
    fig.savefig('chart_750.png', dpi=300)

if __name__ == "__main__":
    filenames = ["750000and200.dat", "750000and400.dat", "750000and600.dat", "750000and800.dat", "750000and1000.dat", "750000and1200.dat"]
