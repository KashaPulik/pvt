...
def draw(filenames, labels):
    ...
    ax.set_title("1000000 элементов")
    ...
    plt.tight_layout()
    ax.legend()
    fig.savefig('chart_1000.png', dpi=300)

if __name__ == "__main__":
    filenames = ["1000000and200.dat", "1000000and400.dat", "1000000and600.dat", "1000000and800.dat", "1000000and1000.dat", "1000000and1200.dat"]
