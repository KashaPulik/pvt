...
def draw(filenames, labels):
    ...
    plt.tight_layout()
    ax.legend()
    fig.savefig('chart_250.png', dpi=300)

if __name__ == "__main__":
    filenames = ["250000and200.dat", "250000and400.dat", "250000and600.dat", "250000and800.dat", "250000and1000.dat", "250000and1200.dat"]
