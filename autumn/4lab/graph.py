...
speedup1 = [initial_time1 / t * 8 for t in times1]
speedup2 = [initial_time2 / t * 8 for t in times2]

plt.figure(figsize=(10, 6))

plt.plot(processes, speedup1, marker='o', linestyle='-', color='b', label="1000")

plt.plot(processes, speedup2, marker='s', linestyle='--', color='r', label="10000")
